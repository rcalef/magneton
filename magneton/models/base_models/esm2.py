...
class ESM2Config(TransformersESMBaseConfig):
    """Configuration options for ESM-2 models"""

    model_size: Literal[ESM2_150M, ESM2_600M, ESM2_3B] = ESM2_150M


class ESM2BaseModel(TransformersESMBaseModel):
